    ...
    <div class="main" style="height:1200px">
        <div class="main-inner main-page">
            <div class="layui-carousel" id="test3" lay-filter="test4">
                <div carousel-item="">
                    <div>
                        <img src="../static/images/白蛇2.jpg" onclick="window.location.href='/jsp/buyTickets.jsp?movie_id=2'">
                    </div>
                    <div>
                        <img src="../static/images/你好世界.jpg" onclick="window.location.href='/jsp/buyTickets.jsp?movie_id=3'">
                    </div>
                    <div>
                        <img src="../static/images/中国医生.jpg" onclick="window.location.href='/jsp/buyTickets.jsp?movie_id=4'">
                    </div>
                    <div>
                        <img src="../static/images/1921.jpg" onclick="window.location.href='/jsp/buyTickets.jsp?movie_id=6'">
                    </div>
                    <div>
                        <img src="../static/images/济公之降龙降世.jpg" onclick="window.location.href='/jsp/buyTickets.jsp?movie_id=9'">
                    </div>
                </div>
            </div> 
            <div class="aside">
